...
{
    /// <inheritdoc />
    public partial class ShippingInvoice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalWeightGrams = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
                    PackingNotes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeRateToThb = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    VatApplicable = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    TotalAmountThb = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightGrams = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
                    UnitValueUsd = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShipmentItems_WorkOrders_WorkOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentItems_WorkOrderId",
                table: "ShipmentItems",
                column: "WorkOrderId");
