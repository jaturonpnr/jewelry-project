        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipAddressLine1 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ShipAddressLine2 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinishedGoodsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrderItems_FinishedGoods_FinishedGoodsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderItems_FinishedGoodsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_Customer_Status",
                table: "SalesOrders",
